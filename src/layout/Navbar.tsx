...
export default function Navbar() {
    const {AllProductQnt, openCart} = useProductContext()
  return (
    <NavBs sticky='top' className='bg-primary shadow-md'>
        <Container>
            <Nav>
            ...
            <Button
            onClick={openCart}
            style={{color: "white",width: "3rem", height: "3rem", position: "relative"}} variant="outline-warning">
        <svg
